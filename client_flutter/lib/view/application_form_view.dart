...
class ApplicationFormView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget studyTypeFieldWidget = DropdownSearchFieldWidget<String>(title: 'ภาคเรียน', item: StudyType.list, initialValue: applicationForm.studyType, getText: (value) => value, onChange: !isWrite ? null : ({value, String? text}) => applicationForm.studyType = value);
    final Widget studyPlanFieldWidget = DropdownSearchFieldWidget<String>(title: 'แผนการเรียน', item: StudyPlan.list, initialValue: applicationForm.studyPlan, getText: (value) => value, onChange: !isWrite ? null : ({value, String? text}) => applicationForm.studyPlan = value);
